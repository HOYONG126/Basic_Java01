...
public class OperatorExample {
	...
	public static void main(String[] args) {
		...
		int minute=((score-day*day1)-time*time1)/360;
		...
		int airplane = 150000000;
		int number=20;
		int disPriceNumber=15;
		int discountPercent=75;
		long allPrice=airplane*disPriceNumber+(airplane*(number-disPriceNumber)*discountPercent/100);
